...
LEVELS.push({
    ...
    grid: [
      ...
      [2,1,1,1,1,2,2,2,2,2,8,4,8,2],
      [2,1,3,1,1,2,2,2,2,2,8,1,8,2],
      [2,1,1,1,1,2,2,2,2,2,2,6,2,2],
      [2,9,9,9,9,2,2,2,2,2,1,1,1,2],
      [2,9,1,1,9,2,2,2,2,2,1,1,11,2],
      [2,9,1,1,9,2,2,2,2,2,1,1,1,2],
      [2,9,9,9,9,2,2,2,2,2,1,9,9,2],
      [2,10,1,1,1,1,1,1,1,1,1,9,2,2],
      [2,2,2,2,2,2,2,2,2,2,2,2,2,2]
    ],
    lasers: [{ emitter:{x:1,z:8}, dir:{dx:1,dz:0}, receiverId:'12_5' }],
    links: [{ receiver:'12_5', door:{x:11,z:3} }],
    amica: {
